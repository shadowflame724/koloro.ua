...
window.addEventListener('load', function() {
    ...
    // var img1 = new Image();
    // img1.src = "images/globino-maslo/landscape-painting-animation.png";
    //
    ...
    setInterval(function () {
        if (patternsLeftState == 0) {
            patternsLeft.src = "images/globino-maslo/patterns-left-animation.png";
            patternsLeftState = 1;
        } else {
            patternsLeft.src = "images/globino-maslo/patterns-left.png";
            patternsLeftState = 0;
        }

        if (patternsRightState == 0) {
            patternsRight.src = "images/globino-maslo/patterns-right-animation.png";
            patternsRightState = 1;
        } else {
            patternsRight.src = "images/globino-maslo/patterns-right.png";
            patternsRightState = 0;
        }

        if (portrait1State == 0) {
            portrait1.src = "images/globino-maslo/portrait1-animation.png";
            portrait1State = 1;
        } else {
            portrait1.src = "images/globino-maslo/portrait1.png";
            portrait1State = 0;
        }

        if (arrow1State == 0) {
            arrow1.src = "images/globino-maslo/arrow-1-animation.png";
            arrow1State = 1;
        } else {
            arrow1.src = "images/globino-maslo/arrow-1.png";
            arrow1State = 0;
        }

        if (arrow2State == 0) {
            arrow2.src = "images/globino-maslo/arrow-2-animation.png";
            arrow2State = 1;
        } else {
            arrow2.src = "images/globino-maslo/arrow-2.png";
            arrow2State = 0;
        }

        if (arrow3State == 0) {
            arrow3.src = "images/globino-maslo/arrow-2-animation.png";
            arrow3State = 1;
        } else {
            arrow3.src = "images/globino-maslo/arrow-2.png";
            arrow3State = 0;
        }

        if (landscapePaintingState == 0) {
            landscapePainting.src = "images/globino-maslo/landscape-painting-animation.png";
            landscapePaintingState = 1;
        } else {
            landscapePainting.src = "images/globino-maslo/landscape-painting.png";
            landscapePaintingState = 0;
        }
