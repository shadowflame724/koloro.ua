...
window.addEventListener('load', function() {
	...
	setInterval(function () {
        ...
        if (parseInt(tempStyle.left) < -plane.clientWidth + 10) {
            ...
            plane.src = "/images/portfolio/mirovaya-tradiciya/plane.png";
        } else if (parseInt(tempStyle.left) > window.innerWidth - 50) {
            // move from right to left
            plane.src = "/images/portfolio/mirovaya-tradiciya/plane-mirror.png";
        }
    }, 5);
    ...
    setInterval(function () {
        ...
        if (parseInt(tempStyle.left) < -birds.clientWidth + 10) {
            // move from left to right
            birds.src = "/images/portfolio/mirovaya-tradiciya/birds.png";
        } else if (parseInt(tempStyle.left) > window.innerWidth - 50) {
            // move from right to left
            birds.src = "/images/portfolio/mirovaya-tradiciya/birds-mirror.png";
        }
    }, 5);
